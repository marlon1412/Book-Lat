         ...
         <div class="cart-items">
            ...
            if ($select_cart->rowCount() > 0) {
               while ($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)) {
                  if ($fetch_cart['status'] == "Rent") {
                     $rentProduct[] = '<p><span class="name">' . $fetch_cart['name'] . '</span><span class="price">₱' . $fetch_cart['price'] . ' x ' . $fetch_cart['quantity'] . '</span></p>';
                     $total_products = implode($cart_items);
                  } else {
                     $buyProduct[] = '<p><span class="name">' . $fetch_cart['name'] . '</span><span class="price">₱' . $fetch_cart['price'] . ' x ' . $fetch_cart['quantity'] . '</span></p>';
                     $total_products = implode($cart_items);
                  }
