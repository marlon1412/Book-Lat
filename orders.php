...
<body>
   ...
   <section class="orders">
      ...
      <div class="box-container">
         <table class="cart-table-header connect table table-dark table-striped-columns table-responsive">
            <thead>
               <tr class="">
                  <th scope="col" class="py-3" style="width: 16%;">Order No</th>
                  <th scope="col" class="py-3" style="width: 16%;">Date</th>
                  <th scope="col" class="py-3" style="width: 16%;">Total</th>
                  <th scope="col" class="py-3" style="width: 16%;">Payment Method</th>
         ...
         ?>
                  ...
                  <table class="cart-table-header connect mb-3 table-responsive">
                     <tbody>
                        <tr>
                           <td scope="col" class="py-3" style="width: 16%;">
                              <span><?= $fetch_orders['placed_on']; ?>-<?= $fetch_orders['total_price']; ?></span>
                           </td>
                           <td scope="col" class="py-3" style="width: 16%;">
